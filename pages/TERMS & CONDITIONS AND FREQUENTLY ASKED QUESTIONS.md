...
<style>
  ...
  **Frequently Asked Questions**<br>
  <dl>
    <dt class="qn">1. Who is eligible to participate in the weekly challenges?</dd>
    <dd>Only Singaporeans are eligible. </dd>
  </dl>
  <dl>
    <dt class="qn">2. Is there a different challenge every week?</dd>
    <dd>Yes, each challenge will tap into a different aspect of defence within Defence Science & Technology sector:<br><br>
  ...
  <dl>
    <dt class="qn">3. How long does each challenge last for?</dd>
    <dd>
  ...
  <dl>
    <dt class="qn">4. Can I submit multiple entries for each challenge?</dd>
    <dd>No. Only the first entry counts.</dd>
  </dl>
  <dl>
    <dt class="qn">5. What are the prizes to be won?</dd>
  ...
  <dl>
    <dt class="qn">6. How do I know if I have won? If so, how do I collect my prize?</dd>
  
    <dd>You will receive an email from us if you have won. The collection details will be stated in the email.</dd>
  </dl>